...
export function useFollowingQuery(
  options: Omit<Urql.UseQueryArgs<FollowingQueryVariables>, 'query'>,
) {
  return Urql.useQuery<FollowingQuery, FollowingQueryVariables>({
...
export function useFollowersQuery(
  options: Omit<Urql.UseQueryArgs<FollowersQueryVariables>, 'query'>,
) {
  return Urql.useQuery<FollowersQuery, FollowersQueryVariables>({
