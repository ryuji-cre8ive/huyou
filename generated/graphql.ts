...
export function useFindUserWithMailQuery(options: Omit<Urql.UseQueryArgs<FindUserWithMailQueryVariables>, 'query'>) {
  return Urql.useQuery<FindUserWithMailQuery, FindUserWithMailQueryVariables>({ query: FindUserWithMailDocument, ...options });
};
...
export function useCreateShopItemMutation() {
  return Urql.useMutation<CreateShopItemMutation, CreateShopItemMutationVariables>(CreateShopItemDocument);
};
...
export function useAppendNameForCreatedUserMutation() {
  return Urql.useMutation<AppendNameForCreatedUserMutation, AppendNameForCreatedUserMutationVariables>(AppendNameForCreatedUserDocument);
};
