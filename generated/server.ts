...
export type FindUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', name: string, image?: string | null, assessment?: number | null, id: string, ShopItem?: Array<{ __typename?: 'ShopItem', id: string, title: string, image: string, price: number }> | null } | null };
...
export type AppendNameForCreatedUserMutation = { __typename?: 'Mutation', appendNameForCreatedUser: { __typename?: 'User', id: string } };
...
export type FollowingQuery = { __typename?: 'Query', following: Array<{ __typename?: 'Follower', id: string, targetUserID: string, targetUser: Array<{ __typename?: 'User', name: string, id: string }> } | null> };
...
export type FollowersQuery = { __typename?: 'Query', followers: Array<{ __typename?: 'Follower', targetUser: Array<{ __typename?: 'User', id: string, name: string }> } | null> };
...
export type FollowMutation = { __typename?: 'Mutation', follow: { __typename?: 'Follower', id: string } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    AppendNameForCreatedUser(variables: AppendNameForCreatedUserMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AppendNameForCreatedUserMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AppendNameForCreatedUserMutation>(AppendNameForCreatedUserDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'AppendNameForCreatedUser', 'mutation');
    },
    Following(variables: FollowingQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FollowingQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FollowingQuery>(FollowingDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Following', 'query');
    },
    Followers(variables: FollowersQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FollowersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FollowersQuery>(FollowersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Followers', 'query');
    },
